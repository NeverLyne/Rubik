...
def main():
    ...
    while True:
        try:
            cube_size = int(input("Enter the Rubik's cube size (2, 3, 4, or 5): "))
            if cube_size in {2, 3, 4, 5}:
                break
            else:
    ...
    for face in face_order:
        ...
        while True:
            ...
            frame_with_grid = draw_grid(frame.copy(), cube_size)
            ...
            if key == ord('s'):
                colors, processed_frame = process_rubiks_image(frame, cube_size)
